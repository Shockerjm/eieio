...
const TextSlice = ({ slice }) => {
  return (
    ...
    >
      <div className={`py-24 gap-16 inline-flex flex-col items-center ${slice.primary.text_align || 'text-center'} w-screen ${slice.primary.background_color ? backgroundColor[slice.primary.background_color] : backgroundColor.Grey}`}>
