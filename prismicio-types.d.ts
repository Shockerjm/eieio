...
export interface SplitImageTextSliceDefaultPrimary {
  ...
  /**
   * Background Color field in *SplitImageText → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: split_image_text.default.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
...
export interface SplitImageTextSliceSplitImageRightPrimary {
  ...
  /**
   * Background Color field in *SplitImageText → Split Image Right → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: split_image_text.splitImageRight.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
...
export interface SplitImageTextSliceSplitButtonLeftPrimary {
  ...
  /**
   * Background Color field in *SplitImageText → Split Button Left → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: split_image_text.splitButtonLeft.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
...
export interface SplitImageTextSliceSplitButtonRightPrimary {
  ...
  /**
   * Background Color field in *SplitImageText → Split Button Right → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: split_image_text.splitButtonRight.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
...
export interface TextSliceSliceDefaultPrimary {
  ...
  /**
   * Background Color field in *TextSlice → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: text_slice.default.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
...
export interface TextSliceSliceCallToActionButtonPrimary {
  ...
  /**
   * Background Color field in *TextSlice → Call To Action Button → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: text_slice.callToActionButton.primary.background_color
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  background_color: prismic.SelectField<"Grey" | "Green">;
}
